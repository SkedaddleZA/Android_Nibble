...
class DAL {
    ...
    private static final String validEmail = "http://SICT-IIS.nmmu.ac.za/skedaddle/validateEmail.php";
   ...
   //Insert customer procedure
    ...
    {
        StringRequest request = new StringRequest(Request.Method.POST, updateCustomerURL, listener, new Response.ErrorListener() {//Create a StringRequest which POSTS data to the database then records the response in listener variable
            @Override
            public void onErrorResponse(VolleyError error) {
    ...
    {
        StringRequest request = new StringRequest(Request.Method.POST, getRestRating, listener ,new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
    ...
    {
        StringRequest request = new StringRequest(Request.Method.POST, validEmail, listener ,new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
